...
// $config['base_url'] = ($_SERVER['SERVER_NAME'] == 'localhost') ? 'https://bythepeople.org.in' : 'https://bythepeople.org.in';
...
// $config['sendinblue_api_key'] = 'YOUR_SENDINBLUE_API_KEY';
/*
|--------------------------------------------------------------------------
| Reverse Proxy IPs
|--------------------------------------------------------------------------
...
$config['curl_options'] = array(
    CURLOPT_CAINFO => FCPATH . 'C:\wamp64\www\bythepeople\application\third_party\cacert\cacert.pem',
);
