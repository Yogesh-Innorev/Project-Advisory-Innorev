  ...
  <script src="<?php echo base_url();?>assets/other/cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>

  <script src="<?php echo base_url();?>assets/js/plugins/arrive.min.js"></script>

  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB2Yno10-YTnLjjn_Vtk0V8cdcY5lC4plU"></script>

  <script async defer src="<?php echo base_url();?>assets/other/buttons.github.io/buttons.js"></script>

  <script src="<?php echo base_url();?>assets/js/plugins/chartist.min.js"></script>

  <script src="<?php echo base_url();?>assets/js/plugins/bootstrap-notify.js"></script>

  <script src="<?php echo base_url();?>assets/js/material-dashboard.min6c54.js?v=2.2.2" type="text/javascript"></script>
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
    ...
    data-cf-beacon='{"rayId":"8ab4febe1fd7447b","version":"2024.7.0","serverTiming":{"name":{"cfL4":true}},"token":"1b7cbb72744b40c580f8633c6b62637e","b":1}'
    crossorigin="anonymous"></script>
</body>

<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro-bs4/examples/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jul 2024 11:31:22 GMT -->
