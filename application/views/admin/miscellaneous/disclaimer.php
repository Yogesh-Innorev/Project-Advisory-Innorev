            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Manage Disclaimer</h4>
                    </div>
                    <div class="card-body">
                        <div class="toolbar">
                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                <div class="button-container" style="float: right;">
                                    <button type="button" class="btn btn-primary" id="prbtn" data-bs-toggle="modal" data-bs-target="#staticBackdrop_add">Add Disclaimer</button>
                                </div>
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td valign="top">
                                                <a href="<?php echo base_url('disclaimer/delete/'.$value['id']); ?>" class="btn btn-danger btn-md center-inline-block">Delete</a>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="staticBackdropLabel">Update Disclaimer</h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Close</button>
        </div>
        <div class="modal-body">
            <form method="POST" action="<?php echo base_url()?>update_disclaimer">
                <div class="mb-3">
...
<div class="modal fade" id="staticBackdrop_add" data-bs-backdrop="static" data-bs-focus="false" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="staticBackdropLabel">Add Disclaimer</h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Close</button>
        </div>
        <div class="modal-body">
            <form method="POST" action="<?php echo base_url()?>adddisclaimer">
                <div class="mb-3">
