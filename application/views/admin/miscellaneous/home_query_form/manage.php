            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Manage Home Query Form</h4>
                    </div>
                    <div class="card-body">
                        <div class="toolbar">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td valign="top">
                                                <a href="<?php echo base_url('home_query/delete/'.$value['id']); ?>" class="btn btn-danger btn-md center-inline-block">Delete</a>
                                                <a href="<?php echo base_url ('home_query/edit/'.$value['id']); ?>" class="btn btn-info btn-md center-inline-block">View</a>
                                            </td>
                                        </tr>
                                    <?php $i++; } ?>
                                </tbody>
