...
<head>
    <meta charset="utf-8">
    <title>R.K Advisory | Project Application Flow</title>
...
<body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Project Application Flow</h4>
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li style="margin: 0 10px;"><a href="<?php echo base_url(); ?>" style="color: #fff;">Home</a></li>
                    <li class="breadcrumb-item active text-primary">Project-Application-Flow</li>
                </ol>   
            </div>
        </div>
        <!-- Header End -->
